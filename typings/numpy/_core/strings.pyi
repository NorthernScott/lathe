...
def encode(a: U_co, encoding: None | str = ..., errors: None | str = ...) -> NDArray[np.bytes_]:
    ...
...
@overload
def split(a: U_co, sep: None | U_co = ..., maxsplit: None | i_co = ...) -> NDArray[np.object_]:
    ...

@overload
def split(a: S_co, sep: None | S_co = ..., maxsplit: None | i_co = ...) -> NDArray[np.object_]:
    ...

@overload
def rsplit(a: U_co, sep: None | U_co = ..., maxsplit: None | i_co = ...) -> NDArray[np.object_]:
    ...

@overload
def rsplit(a: S_co, sep: None | S_co = ..., maxsplit: None | i_co = ...) -> NDArray[np.object_]:
    ...
...
@overload
def translate(a: U_co, table: U_co, deletechars: None | U_co = ...) -> NDArray[np.str_]:
    ...

@overload
def translate(a: S_co, table: S_co, deletechars: None | S_co = ...) -> NDArray[np.bytes_]:
    ...
