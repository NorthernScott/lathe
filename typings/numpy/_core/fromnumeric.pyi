...
@overload
def reshape(a: _ArrayLike[_SCT], /, shape: _ShapeLike = ..., order: _OrderACF = ..., *, newshape: _ShapeLike = ..., copy: None | bool = ...) -> NDArray[_SCT]:
    ...

@overload
def reshape(a: ArrayLike, /, shape: _ShapeLike = ..., order: _OrderACF = ..., *, newshape: _ShapeLike = ..., copy: None | bool = ...) -> NDArray[Any]:
    ...
...
@overload
def clip(a: _SCT, a_min: None | ArrayLike, a_max: None | ArrayLike, out: None = ..., *, min: None | ArrayLike = ..., max: None | ArrayLike = ..., dtype: None = ..., where: None | _ArrayLikeBool_co = ..., order: _OrderKACF = ..., subok: bool = ..., signature: str | tuple[None | str, ...] = ..., casting: _CastingKind = ...) -> _SCT:
    ...

@overload
def clip(a: _ScalarLike_co, a_min: None | ArrayLike, a_max: None | ArrayLike, out: None = ..., *, min: None | ArrayLike = ..., max: None | ArrayLike = ..., dtype: None = ..., where: None | _ArrayLikeBool_co = ..., order: _OrderKACF = ..., subok: bool = ..., signature: str | tuple[None | str, ...] = ..., casting: _CastingKind = ...) -> Any:
    ...

@overload
def clip(a: _ArrayLike[_SCT], a_min: None | ArrayLike, a_max: None | ArrayLike, out: None = ..., *, min: None | ArrayLike = ..., max: None | ArrayLike = ..., dtype: None = ..., where: None | _ArrayLikeBool_co = ..., order: _OrderKACF = ..., subok: bool = ..., signature: str | tuple[None | str, ...] = ..., casting: _CastingKind = ...) -> NDArray[_SCT]:
    ...

@overload
def clip(a: ArrayLike, a_min: None | ArrayLike, a_max: None | ArrayLike, out: None = ..., *, min: None | ArrayLike = ..., max: None | ArrayLike = ..., dtype: None = ..., where: None | _ArrayLikeBool_co = ..., order: _OrderKACF = ..., subok: bool = ..., signature: str | tuple[None | str, ...] = ..., casting: _CastingKind = ...) -> NDArray[Any]:
    ...

@overload
def clip(a: ArrayLike, a_min: None | ArrayLike, a_max: None | ArrayLike, out: _ArrayType = ..., *, min: None | ArrayLike = ..., max: None | ArrayLike = ..., dtype: DTypeLike, where: None | _ArrayLikeBool_co = ..., order: _OrderKACF = ..., subok: bool = ..., signature: str | tuple[None | str, ...] = ..., casting: _CastingKind = ...) -> Any:
    ...

@overload
def clip(a: ArrayLike, a_min: None | ArrayLike, a_max: None | ArrayLike, out: _ArrayType, *, min: None | ArrayLike = ..., max: None | ArrayLike = ..., dtype: DTypeLike = ..., where: None | _ArrayLikeBool_co = ..., order: _OrderKACF = ..., subok: bool = ..., signature: str | tuple[None | str, ...] = ..., casting: _CastingKind = ...) -> _ArrayType:
    ...
...
@overload
def cumulative_sum(x: _ArrayLike[_SCT], /, *, axis: None | SupportsIndex = ..., dtype: None = ..., out: None = ..., include_initial: bool = ...) -> NDArray[_SCT]:
    ...

@overload
def cumulative_sum(x: ArrayLike, /, *, axis: None | SupportsIndex = ..., dtype: None = ..., out: None = ..., include_initial: bool = ...) -> NDArray[Any]:
    ...

@overload
def cumulative_sum(x: ArrayLike, /, *, axis: None | SupportsIndex = ..., dtype: _DTypeLike[_SCT] = ..., out: None = ..., include_initial: bool = ...) -> NDArray[_SCT]:
    ...

@overload
def cumulative_sum(x: ArrayLike, /, *, axis: None | SupportsIndex = ..., dtype: DTypeLike = ..., out: None = ..., include_initial: bool = ...) -> NDArray[Any]:
    ...

@overload
def cumulative_sum(x: ArrayLike, /, *, axis: None | SupportsIndex = ..., dtype: DTypeLike = ..., out: _ArrayType = ..., include_initial: bool = ...) -> _ArrayType:
    ...
...
@overload
def cumulative_prod(x: _ArrayLikeBool_co, /, *, axis: None | SupportsIndex = ..., dtype: None = ..., out: None = ..., include_initial: bool = ...) -> NDArray[int_]:
    ...

@overload
def cumulative_prod(x: _ArrayLikeUInt_co, /, *, axis: None | SupportsIndex = ..., dtype: None = ..., out: None = ..., include_initial: bool = ...) -> NDArray[uint64]:
    ...

@overload
def cumulative_prod(x: _ArrayLikeInt_co, /, *, axis: None | SupportsIndex = ..., dtype: None = ..., out: None = ..., include_initial: bool = ...) -> NDArray[int64]:
    ...

@overload
def cumulative_prod(x: _ArrayLikeFloat_co, /, *, axis: None | SupportsIndex = ..., dtype: None = ..., out: None = ..., include_initial: bool = ...) -> NDArray[floating[Any]]:
    ...

@overload
def cumulative_prod(x: _ArrayLikeComplex_co, /, *, axis: None | SupportsIndex = ..., dtype: None = ..., out: None = ..., include_initial: bool = ...) -> NDArray[complexfloating[Any, Any]]:
    ...

@overload
def cumulative_prod(x: _ArrayLikeObject_co, /, *, axis: None | SupportsIndex = ..., dtype: None = ..., out: None = ..., include_initial: bool = ...) -> NDArray[object_]:
    ...

@overload
def cumulative_prod(x: _ArrayLikeComplex_co | _ArrayLikeObject_co, /, *, axis: None | SupportsIndex = ..., dtype: _DTypeLike[_SCT] = ..., out: None = ..., include_initial: bool = ...) -> NDArray[_SCT]:
    ...

@overload
def cumulative_prod(x: _ArrayLikeComplex_co | _ArrayLikeObject_co, /, *, axis: None | SupportsIndex = ..., dtype: DTypeLike = ..., out: None = ..., include_initial: bool = ...) -> NDArray[Any]:
    ...

@overload
def cumulative_prod(x: _ArrayLikeComplex_co | _ArrayLikeObject_co, /, *, axis: None | SupportsIndex = ..., dtype: DTypeLike = ..., out: _ArrayType = ..., include_initial: bool = ...) -> _ArrayType:
    ...
