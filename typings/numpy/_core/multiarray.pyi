...
from numpy import _CastingKind, _CopyMode, _IOProtocol, _ModeKind, _NDIterFlagsKind, _NDIterOpFlagsKind, _OrderCF, _OrderKACF, _SupportsBuffer, busdaycalendar as busdaycalendar, complexfloating, datetime64, dtype as dtype, float64, floating, generic, int_, intp, ndarray as ndarray, nditer as nditer, signedinteger, str_, timedelta64, ufunc, uint8, unsignedinteger
...
_ArrayType_co = TypeVar("_ArrayType_co", bound=ndarray[Any, Any], covariant=True)
...
@overload
def array(object: _SupportsArray[_ArrayType], dtype: None = ..., *, copy: None | bool | _CopyMode = ..., order: _OrderKACF = ..., subok: L[True], ndmin: L[0] = ..., like: None | _SupportsArrayFunc = ...) -> _ArrayType:
    ...
...
@overload
def asanyarray(a: _ArrayType, dtype: None = ..., order: _OrderKACF = ..., *, device: None | L["cpu"] = ..., copy: None | bool = ..., like: None | _SupportsArrayFunc = ...) -> _ArrayType:
    ...

@overload
def asanyarray(a: _ArrayLike[_SCT], dtype: None = ..., order: _OrderKACF = ..., *, device: None | L["cpu"] = ..., copy: None | bool = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def asanyarray(a: object, dtype: None = ..., order: _OrderKACF = ..., *, device: None | L["cpu"] = ..., copy: None | bool = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def asanyarray(a: Any, dtype: _DTypeLike[_SCT], order: _OrderKACF = ..., *, device: None | L["cpu"] = ..., copy: None | bool = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def asanyarray(a: Any, dtype: DTypeLike, order: _OrderKACF = ..., *, device: None | L["cpu"] = ..., copy: None | bool = ..., like: None | _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...
