...
from typing import Any, Literal, NamedTuple, TypeVar, TypedDict, overload
from numpy import dtype, uint32, uint64
from numpy._typing import NDArray, _ArrayLikeInt_co, _ShapeLike, _SupportsDType, _UInt32Codes, _UInt64Codes

_T = TypeVar("_T")
_DTypeLikeUint32 = (dtype[uint32] | _SupportsDType[dtype[uint32]] | type[uint32] | _UInt32Codes)
_DTypeLikeUint64 = (dtype[uint64] | _SupportsDType[dtype[uint64]] | type[uint64] | _UInt64Codes)
