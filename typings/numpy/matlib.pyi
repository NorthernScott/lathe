...
def empty(shape, dtype=..., order=...): # -> matrix[Any, Any]:
...
def ones(shape, dtype=..., order=...): # -> matrix[Any, Any]:
    """
    Matrix of ones.
...
def zeros(shape, dtype=..., order=...): # -> matrix[Any, Any]:
    """
...
def identity(n, dtype=...): # -> matrix[Any, Any]:
    """
