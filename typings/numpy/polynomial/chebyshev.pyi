...
from typing import Any, Concatenate, Final, Literal as L, TypeVar, overload
from numpy._typing import _IntLike_co
from ._polybase import ABCPolyBase
from ._polytypes import _Array1, _Array2, _CoefSeries, _FuncBinOp, _FuncCompanion, _FuncDer, _FuncFit, _FuncFromRoots, _FuncGauss, _FuncInteg, _FuncLine, _FuncPoly2Ortho, _FuncPow, _FuncPts, _FuncRoots, _FuncUnOp, _FuncVal, _FuncVal2D, _FuncVal3D, _FuncValFromRoots, _FuncVander, _FuncVander2D, _FuncVander3D, _FuncWeight, _SeriesLikeCoef_co
...
@overload
def chebinterpolate(func: np.ufunc, deg: _IntLike_co, args: tuple[()] = ...) -> npt.NDArray[np.float64 | np.complex128 | np.object_]:
    ...

@overload
def chebinterpolate(func: Callable[[npt.NDArray[np.float64]], _RT], deg: _IntLike_co, args: tuple[()] = ...) -> npt.NDArray[_RT]:
    ...

@overload
def chebinterpolate(func: Callable[Concatenate[npt.NDArray[np.float64], ...], _RT], deg: _IntLike_co, args: Iterable[Any]) -> npt.NDArray[_RT]:
    ...
...
class Chebyshev(ABCPolyBase[L["T"]]):
    @overload
    @classmethod
    def interpolate(cls: type[_Self], /, func: Callable[[npt.NDArray[np.float64]], _CoefSeries], deg: _IntLike_co, domain: None | _SeriesLikeCoef_co = ..., args: tuple[()] = ...) -> _Self:
        ...
    
    @overload
    @classmethod
    def interpolate(cls: type[_Self], /, func: Callable[Concatenate[npt.NDArray[np.float64], ...], _CoefSeries,], deg: _IntLike_co, domain: None | _SeriesLikeCoef_co = ..., *, args: Iterable[Any]) -> _Self:
        ...
