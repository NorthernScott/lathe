...
def getargs(co): # -> tuple[list[Any], Any | None, Any | None]:
...
def getargspec(func): # -> tuple[list[Any], Any | None, Any | None, Any]:
...
def getargvalues(frame): # -> tuple[list[Any], Any | None, Any | None, Any]:
