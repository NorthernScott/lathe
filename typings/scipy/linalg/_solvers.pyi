...
def solve_sylvester(a, b, q): # -> NDArray[float64] | Any:
    """
...
def solve_continuous_lyapunov(a, q): # -> NDArray[float64] | Any:
    """
...
solve_lyapunov = ...
def solve_discrete_lyapunov(a, q, method=...): # -> NDArray[Any] | NDArray[float64] | Any:
    """
