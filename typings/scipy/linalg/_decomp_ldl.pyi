...
__all__ = ['ldl']
def ldl(A, lower=..., hermitian=..., overwrite_a=..., check_finite=...): # -> tuple[NDArray[floating[_64Bit]], NDArray[floating[_64Bit]], NDArray[Any]] | tuple[Any, NDArray[Any], NDArray[intp]]:
