...
"""
__all__ = ['loadmat', 'savemat', 'whosmat', 'MatlabObject', 'matfile_version', 'MatReadError', 'MatReadWarning', 'MatWriteError', 'mat_struct', 'MatlabOpaque', 'MatlabFunction', 'varmats_from_mat']
test = ...
