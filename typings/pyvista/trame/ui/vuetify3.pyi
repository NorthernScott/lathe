...
if TYPE_CHECKING:
    ...
def button(click, icon, tooltip): # -> None:
    """Create a vuetify button."""
    ...

def checkbox(model, icons, tooltip): # -> None:
    """Create a vuetify checkbox."""
    ...

def slider(model, tooltip, **kwargs): # -> None:
    """Create a vuetify slider."""
    ...

def text_field(model, tooltip, **kwargs): # -> None:
    """Create a vuetify text field."""
    ...

def select(model, tooltip, **kwargs): # -> None:
    """Create a vuetify select menu."""
    ...

def divider(**kwargs): # -> None:
...
class Viewer(BaseViewer):
    ...
    def ui_controls(self, mode=..., default_server_rendering=..., v_show=...): # -> None:
    ...
    def ui(self, mode=..., default_server_rendering=..., collapse_menu=..., add_menu=..., add_menu_items=..., **kwargs): # -> PyVistaRemoteLocalView | PyVistaRemoteView | PyVistaLocalView:
