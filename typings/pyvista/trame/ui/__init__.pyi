...
UI_TITLE = ...
def get_viewer(plotter, server=..., suppress_rendering=...): # -> BaseViewer | pyvista.trame.ui.vuetify2.Viewer | pyvista.trame.ui.vuetify3.Viewer:
...
def plotter_ui(plotter, mode=..., default_server_rendering=..., collapse_menu=..., add_menu=..., **kwargs): # -> PyVistaRemoteLocalView | PyVistaRemoteView | PyVistaLocalView:
