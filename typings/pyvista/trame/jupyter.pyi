...
def launch_server(server=..., port=..., host=..., wslink_backend=..., **kwargs): # -> Server | None:
...
def build_url(_server, ui=..., server_proxy_enabled=..., server_proxy_prefix=..., host=..., protocol=...): # -> str:
    """Build the URL for the iframe."""
    ...

def initialize(server, plotter, mode=..., default_server_rendering=..., collapse_menu=..., **kwargs): # -> BaseViewer | pyvista.trame.ui.vuetify2.Viewer | pyvista.trame.ui.vuetify3.Viewer:
    """Generate the UI for a given plotter."""
    ...

def show_trame(plotter, mode=..., name=..., server_proxy_enabled=..., server_proxy_prefix=..., jupyter_extension_enabled=..., collapse_menu=..., add_menu=..., add_menu_items=..., default_server_rendering=..., handler=..., **kwargs): # -> EmbeddableWidget | object | Widget:
...
def elegantly_launch(*args, **kwargs): # -> None:
