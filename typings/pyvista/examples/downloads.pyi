...
def download_masonry_texture(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_usa_texture(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_puppy_texture(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_puppy(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_puppy = ...
def download_usa(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_usa = ...
def download_st_helens(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_st_helens = ...
def download_bunny(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_bunny = ...
def download_bunny_coarse(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_cow(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_cow = ...
def download_cow_head(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_cow_head = ...
def download_faults(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_faults = ...
def download_tensors(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_tensors = ...
def download_head(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_head = ...
def download_head_2(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
    """Download head dataset.
...
_dataset_head_2 = ...
def download_bolt_nut(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_bolt_nut = ...
def download_clown(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_clown = ...
def download_topo_global(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_topo_land(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_topo_land = ...
def download_coastlines(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_coastlines = ...
def download_knee(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_knee = ...
def download_knee_full(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_knee_full = ...
def download_lidar(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_lidar = ...
def download_exodus(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_exodus = ...
def download_nefertiti(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_nefertiti = ...
def download_blood_vessels(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_iron_protein(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_tetrahedron(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_saddle_surface(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_sparse_points(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_foot_bones(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_foot_bones = ...
def download_guitar(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_guitar = ...
def download_quadratic_pyramid(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_bird(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_bird = ...
def download_bird_texture(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_office(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_office = ...
def download_horse_points(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_horse(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_horse = ...
def download_cake_easy(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_cake_easy = ...
def download_cake_easy_texture(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_rectilinear_grid(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_gourds(zoom=..., load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_gourds = ...
__gourds2 = ...
def download_gourds_texture(zoom=..., load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
__gourds2_texture = ...
def download_gourds_pnm(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_gourds_pnm = ...
def download_unstructured_grid(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_letter_k(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_letter_k = ...
def download_letter_a(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_letter_a = ...
def download_poly_line(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_poly_line = ...
def download_cad_model(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_cad_model = ...
def download_frog(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_frog = ...
def download_frog_tissue(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_chest(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_chest = ...
def download_brain_atlas_with_sides(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_prostate(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_prostate = ...
def download_filled_contours(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_doorman(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_doorman = ...
def download_mug(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_mug = ...
def download_oblique_cone(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_emoji(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_emoji = ...
def download_emoji_texture(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_teapot(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_teapot = ...
def download_brain(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_brain = ...
def download_structured_grid(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_structured_grid_two(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_trumpet(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_trumpet = ...
def download_face(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_face = ...
def download_sky_box_nz(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_sky_box_nz = ...
def download_sky_box_nz_texture(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_disc_quads(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_disc_quads = ...
def download_honolulu(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_honolulu = ...
def download_motor(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_motor = ...
def download_tri_quadratic_hexahedron(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_human(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_human = ...
def download_vtk(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_vtk = ...
def download_spider(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_spider = ...
def download_carotid(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_carotid = ...
def download_blow(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_blow = ...
def download_shark(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_shark = ...
def download_dragon(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_dragon = ...
def download_armadillo(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_armadillo = ...
def download_gears(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_gears = ...
def download_torso(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_torso = ...
def download_kitchen(split=..., load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_kitchen = ...
__kitchen_split = ...
def download_tetra_dc_mesh(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_model_with_variance(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_thermal_probes(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_carburetor(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_carburetor = ...
def download_turbine_blade(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_pine_roots(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_pine_roots = ...
def download_crater_topo(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_crater_imagery(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_dolfin(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_dolfin = ...
def download_damavand_volcano(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_delaunay_example(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_embryo(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_embryo = ...
def download_antarctica_velocity(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_room_surface_mesh(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_beach(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_beach = ...
def download_rgba_texture(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_vtk_logo(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_vtk_logo = ...
def download_sky_box_cube_map(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_cubemap_park(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_cubemap_space_4k(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_cubemap_space_16k(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_backward_facing_step(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_gpr_data_array(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_gpr_path(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_gpr_path = ...
def download_woman(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_woman = ...
def download_lobster(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_lobster = ...
def download_face2(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_face2 = ...
def download_urn(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_urn = ...
def download_pepper(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_pepper = ...
def download_drill(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_drill = ...
def download_action_figure(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_notch_stress(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_notch_displacement(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_louis_louvre(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_cylinder_crossflow(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_naca(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_naca = ...
def download_lshape(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_lshape = ...
def download_wavy(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_wavy = ...
def download_single_sphere_animation(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_dual_sphere_animation(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_osmnx_graph(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_cavity(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_cavity = ...
def download_openfoam_tubes(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_lucy(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_lucy = ...
def download_pump_bracket(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_electronics_cooling(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_can(partial=..., load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_can = ...
__can_partial = ...
def download_can_crushed_hdf(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_can_crushed_vtu(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
    """Download the crushed can dataset.
...
def download_cgns_structured(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_tecplot_ascii(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_cgns_multi(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_parched_canal_4k(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_cells_nd(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_cells_nd = ...
def download_moonlanding_image(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_angular_sector(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_mount_damavand(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_particles_lethe(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_gif_simple(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_gif_simple = ...
def download_cloud_dark_matter(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_cloud_dark_matter_dense(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_stars_cloud_hyg(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_fea_bracket(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_fea_hertzian_contact_cylinder(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_black_vase(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_black_vase = ...
def download_ivan_angel(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_ivan_angel = ...
def download_bird_bath(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_bird_bath = ...
def download_owl(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_owl = ...
def download_plastic_vase(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_sea_vase(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_sea_vase = ...
def download_dikhololo_night(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_cad_model_case(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_aero_bracket(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_coil_magnetic_field(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_meshio_xdmf(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_victorian_goblet_face_illusion(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_reservoir(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_reservoir = ...
def download_whole_body_ct_male(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_whole_body_ct_female(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_room_cff(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_room_cff = ...
def download_m4_total_density(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_headsq(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_headsq = ...
def download_prism(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_prism = ...
def download_t3_grid_0(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_t3_grid_0 = ...
def download_caffeine(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_caffeine = ...
def download_e07733s002i009(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
def download_particles(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_particles = ...
def download_prostar(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
...
_dataset_prostar = ...
def download_3gqp(load=...): # -> DatasetObject | UnstructuredGrid | pyvista_ndarray | type[DataSet] | type[Texture] | type[ndarray[Any, dtype[Any]]] | type[MultiBlock] | str | tuple[str, ...] | None:
