...
def doc_subs(member): # -> Callable[..., object]:
    """Doc subs wrapper.
...
class Axis(_vtkWrapper, _vtk.vtkAxis):
    ...
    @property
    def tick_locations(self): # -> tuple[Any, ...]:
    ...
    @property
    def tick_labels(self): # -> tuple[Any, ...]:
    ...
    @property
    def tick_labels_offset(self): # -> float:
...
class _CustomContextItem(_vtk.vtkPythonItem):
    class ItemWrapper:
        def Initialize(self, item): # -> Literal[True]:
            ...
    ...
    def paint(self, painter): # -> Literal[True]:
        ...
...
class _Chart(DocSubs):
    ...
    @property
    @doc_subs
    def background_texture(self): # -> Texture | None:
    ...
    @property
    @doc_subs
    def active_background_color(self): # -> Color:
...
class ScatterPlot2D(_Plot, _vtk.vtkPlotPoints):
    ...
    @marker_style.setter
    def marker_style(self, val): # -> None:
        ...
...
class BarPlot(_MultiCompPlot, _vtk.vtkPlotBar):
    ...
    @property
    def y(self): # -> tuple[pyvista_ndarray, ...]:
...
class StackPlot(_MultiCompPlot, _vtk.vtkPlotStacked):
    ...
    @property
    def ys(self): # -> tuple[pyvista_ndarray, ...]:
...
class Chart2D(_Chart, _vtk.vtkChartXY):
    ...
    def plot(self, x, y=..., fmt=...): # -> tuple[AreaPlot | BarPlot | LinePlot2D | ScatterPlot2D | StackPlot | None, AreaPlot | BarPlot | LinePlot2D | ScatterPlot2D | StackPlot | None]:
    ...
    def scatter(self, x, y, color=..., size=..., style=..., label=...): # -> AreaPlot | BarPlot | LinePlot2D | ScatterPlot2D | StackPlot:
    ...
    def line(self, x, y, color=..., width=..., style=..., label=...): # -> AreaPlot | BarPlot | LinePlot2D | ScatterPlot2D | StackPlot:
    ...
    def area(self, x, y1, y2=..., color=..., label=...): # -> AreaPlot | BarPlot | LinePlot2D | ScatterPlot2D | StackPlot:
    ...
    def bar(self, x, y, color=..., orientation=..., label=...): # -> AreaPlot | BarPlot | LinePlot2D | ScatterPlot2D | StackPlot:
    ...
    def stack(self, x, ys, colors=..., labels=...): # -> AreaPlot | BarPlot | LinePlot2D | ScatterPlot2D | StackPlot:
    ...
    def plots(self, plot_type=...): # -> Generator[Any, Any, None]:
    ...
    def remove_plot(self, plot): # -> None:
...
class BoxPlot(_MultiCompPlot, _vtk.vtkPlotBox):
    ...
    @property
    def data(self): # -> tuple[pyvista_ndarray, ...]:
    ...
    @property
    def stats(self): # -> tuple[pyvista_ndarray, ...]:
...
class ChartBox(_Chart, _vtk.vtkChartBox):
    ...
    @property
    def size(self): # -> tuple[Literal[1], Literal[1]]:
        """Return or set the chart size in normalized coordinates.
    ...
    @property
    def loc(self): # -> tuple[Literal[0], Literal[0]]:
        """Return or set the chart position in normalized coordinates.
...
class ChartMPL(_Chart, _vtk.vtkImageItem):
    ...
    @property
    def redraw_on_render(self): # -> bool:
...
class Charts:
    ...
    def set_interaction(self, interactive, toggle=...): # -> list[Any]:
    ...
    def get_charts_by_pos(self, pos): # -> list[Any]:
