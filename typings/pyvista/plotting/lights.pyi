...
class Light(vtkLight):
    ...
    @property
    def shadow_attenuation(self): # -> float:
    ...
    def shadow_attenuation(self, value): # -> None:
        ...
    ...
    @focal_point.setter
    def focal_point(self, pos): # -> None:
        ...
    
    @property
    def world_focal_point(self): # -> Tuple[float, float, float]:
    ...
    @positional.setter
    def positional(self, state): # -> None:
        ...
    ...
    @cone_angle.setter
    def cone_angle(self, angle): # -> None:
        ...
    
    @property
    def attenuation_values(self): # -> Tuple[float, float, float]:
    ...
    def attenuation_values(self, values): # -> None:
        ...
    ...
    def transform_matrix(self, matrix): # -> None:
        ...
    ...
    @light_type.setter
    def light_type(self, ltype): # -> None:
        ...
    
    @property
    def is_headlight(self): # -> bool:
    ...
    def set_direction_angle(self, elev, azim): # -> None:
    ...
    @classmethod
    def from_vtk(cls, vtk_light): # -> Self:
