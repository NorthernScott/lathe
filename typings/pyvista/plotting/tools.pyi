...
def create_axes_marker(label_color=..., x_color=..., y_color=..., z_color=..., xlabel=..., ylabel=..., zlabel=..., labels_off=..., line_width=..., cone_radius=..., shaft_length=..., tip_length=..., ambient=..., label_size=...): # -> vtkAxesActor:
...
def create_axes_orientation_box(line_width=..., text_scale=..., edge_color=..., x_color=..., y_color=..., z_color=..., xlabel=..., ylabel=..., zlabel=..., x_face_color=..., y_face_color=..., z_face_color=..., color_box=..., label_color=..., labels_off=..., opacity=..., show_text_edges=...): # -> vtkPropAssembly | vtkAnnotatedCubeActor:
...
def create_north_arrow(): # -> PolyData:
...
def opacity_transfer_function(mapping, n_colors, interpolate=..., kind=...): # -> NDArray[unsignedinteger[_8Bit]] | NDArray[Any]:
