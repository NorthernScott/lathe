...
class _LightingConfig(_ThemeConfig):
    ...
    def interpolation(self, interpolation: str | int | InterpolationType): # -> None:
        ...
...
class _TrameConfig(_ThemeConfig):
    ...
    def interactive_ratio(self, interactive_ratio: Number): # -> None:
        ...
    ...
    @still_ratio.setter
    def still_ratio(self, still_ratio: Number): # -> None:
        ...
    
    @property
    def jupyter_server_name(self): # -> str:
    ...
    @property
    def server_proxy_prefix(self): # -> str:
...
class Theme(_ThemeConfig):
    ...
    @property
    def color_cycler(self): # -> Cycler[str, str] | Any | Cycler[str, Any] | Cycler[Any, Any] | None:
    ...
    @color_cycler.setter
    def color_cycler(self, color_cycler): # -> None:
        ...
    ...
    def colorbar_vertical(self, config: _ColorbarConfig): # -> None:
        ...
    ...
    def multi_rendering_splitting_position(self, multi_rendering_splitting_position: float): # -> None:
        ...
    ...
    def before_close_callback(self, value: Callable[[pyvista.Plotter], None]): # -> None:
        ...
    ...
    @logo_file.setter
    def logo_file(self, logo_file: str | pathlib.Path | None): # -> None:
        ...
