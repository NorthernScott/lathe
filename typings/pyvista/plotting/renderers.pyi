...
class Renderers:
    ...
    def set_active_renderer(self, index_row, index_column=...):
    ...
    def set_background(self, color, top=..., right=..., side=..., corner=..., all_renderers=...):
    ...
    def set_color_cycler(self, color_cycler, all_renderers=...):
