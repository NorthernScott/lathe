...
class BasePlotter(PickingHelper, WidgetHelper):
    ...
    **kwargs : dict, optional
    ...
    @property
    def suppress_rendering(self): # -> bool:
    ...
    def import_gltf(self, filename, set_camera=...): # -> None:
    ...
    def export_html(self, filename): # -> StringIO | None:
    ...
    def export_vtksz(self, filename=..., format=...): # -> bytes | str | None:
    ...
    def export_gltf(self, filename, inline_data=..., rotate_scene=..., save_normals=...): # -> None:
    ...
    def enable_hidden_line_removal(self, all_renderers=...): # -> None:
    ...
    def disable_hidden_line_removal(self, all_renderers=...): # -> None:
    ...
    @property
    def scalar_bars(self): # -> ScalarBars:
        """Scalar bars.
    ...
    def enable_3_lights(self, only_active=...): # -> None:
    ...
    def enable_lightkit(self, only_active=...): # -> None:
    ...
    def enable_anti_aliasing(self, aa_type=..., multi_samples=..., all_renderers=...): # -> None:
    ...
    def disable_anti_aliasing(self, all_renderers=...): # -> None:
    ...
    def set_focus(self, *args, render=..., **kwargs): # -> None:
        """Wrap ``Renderer.set_focus``."""
        ...
    
    @wraps(Renderer.set_position)
    def set_position(self, *args, render=..., **kwargs): # -> None:
        """Wrap ``Renderer.set_position``."""
        ...
    
    @wraps(Renderer.set_viewup)
    def set_viewup(self, *args, render=..., **kwargs): # -> None:
    ...
    def set_chart_interaction(self, *args, **kwargs): # -> list[Any]:
    ...
    def disable_eye_dome_lighting(self, *args, **kwargs): # -> None:
    ...
    def remove_actor(self, *args, **kwargs): # -> Literal[True]:
    ...
    @camera_set.setter
    def camera_set(self, is_set): # -> None:
        ...
    ...
    @contextmanager
    def window_size_context(self, window_size=...): # -> Generator[Self, Any, None]:
    ...
    @property
    def image(self): # -> DataSet | pyvista_ndarray | NumpyArray | ndarray[Any, Any] | None:
    ...
    @contextmanager
    def image_scale_context(self, scale: int | None = ...): # -> Generator[Self, Any, None]:
    ...
    def add_on_render_callback(self, callback, render_event=...): # -> None:
    ...
    def track_click_position(self, *args, **kwargs): # -> None:
        """Wrap RenderWindowInteractor.track_click_position."""
        ...
    
    @wraps(RenderWindowInteractor.untrack_click_position)
    def untrack_click_position(self, *args, **kwargs): # -> None:
        """Stop tracking the click position."""
        ...
    
    @property
    def pickable_actors(self): # -> list[Any]:
    ...
    def key_press_event(self, *args, **kwargs): # -> None:
    ...
    def enable_custom_trackball_style(self, *args, **kwargs): # -> None:
    ...
    def enable_terrain_style(self, *args, **kwargs): # -> None:
    ...
    def update(self, stime=..., force_redraw=...): # -> None:
    ...
    def update_scalars(self, scalars, mesh=..., render=...): # -> None:
    ...
    def update_coordinates(self, points, mesh=..., render=...): # -> None:
    ...
    def add_text(self, text, position=..., font_size=..., color=..., font=..., shadow=..., name=..., viewport=..., orientation=..., font_file=..., *, render=...): # -> CornerAnnotation | Text:
    ...
    def open_movie(self, filename, framerate=..., quality=..., **kwargs): # -> None:
    ...
    def open_gif(self, filename, loop=..., fps=..., palettesize=..., subrectangles=..., **kwargs): # -> None:
        """Open a gif file.
    ...
    def add_lines(self, lines, color=..., width=..., label=..., name=..., connected=...): # -> Actor:
    ...
    def add_point_scalar_labels(self, points, labels, fmt=..., preamble=..., **kwargs): # -> vtkActor2D:
    ...
    def save_graphic(self, filename, title=..., raster=..., painter=...): # -> None:
    ...
    def screenshot(self, filename=..., transparent_background=..., return_img=..., window_size=..., scale=...): # -> None:
    ...
    def set_color_cycler(self, *args, **kwargs): # -> None:
        """Wrap ``Renderers.set_color_cycler``."""
        ...
    
    def generate_orbital_path(self, factor=..., n_points=..., viewup=..., shift=...): # -> DataSet | pyvista_ndarray | None:
    ...
    def orbit_on_path(self, path=..., focus=..., step=..., viewup=..., write_frames=..., threaded=..., progress_bar=...): # -> None:
    ...
    def add_background_image(self, image_path, scale=..., auto_resize=..., as_global=...): # -> None:
    ...
    def add_light(self, light, only_active=...): # -> None:
    ...
    def remove_all_lights(self, only_active=...): # -> None:
    ...
    def where_is(self, name): # -> list[tuple[Any, ...]]:
...
class Plotter(BasePlotter):
    ...
    def add_title(self, title, font_size=..., color=..., font=..., shadow=...): # -> CornerAnnotation | Text:
