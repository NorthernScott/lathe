...
class lookup_table_ndarray(np.ndarray):
    ...
    """
    def __new__(cls, array, table=...): # -> Self:
        """Allocate the array."""
        ...
    ...
    def __array_wrap__(self, out_arr, context=...): # -> ndarray[Any, Any]:
...
class LookupTable(_vtk.vtkLookupTable):
    ...
    @nan_color.setter
    def nan_color(self, value): # -> None:
        ...
    
    @property
    def nan_opacity(self): # -> int:
    ...
    @nan_opacity.setter
    def nan_opacity(self, value): # -> None:
        ...
    ...
    @property
    def above_range_opacity(self): # -> int:
    ...
    def above_range_opacity(self, value): # -> None:
        ...
    ...
    @property
    def below_range_opacity(self): # -> int:
    ...
    def below_range_opacity(self, value): # -> None:
        ...
    
    def apply_cmap(self, cmap, n_values: int = ..., flip: bool = ...): # -> None:
    ...
    def apply_opacity(self, opacity, interpolate: bool = ..., kind: str = ...): # -> None:
    ...
    def __call__(self, value): # -> tuple[float, float, float] | tuple[float, float, float, float] | NDArray[Any]:
