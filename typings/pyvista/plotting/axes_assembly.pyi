...
class AxesAssembly(_vtk.vtkPropAssembly):
    ...
    **kwargs
    ...
    def set_actor_prop(self, name: str, value: float | str | ColorLike | Sequence[float | str | ColorLike], axis: Literal['x', 'y', 'z', 'all'] = ..., part: Literal['shaft', 'tip', 'all'] = ...):
    ...
    @scale.setter
    def scale(self, scale: VectorLike[float]):
        ...
    ...
    @orientation.setter
    def orientation(self, orientation: tuple[float, float, float]):
        ...
    ...
    @origin.setter
    def origin(self, origin: tuple[float, float, float]):
        ...
    ...
    @user_matrix.setter
    def user_matrix(self, matrix: TransformLike):
        ...
...
class AxesAssemblySymmetric(AxesAssembly):
    ...
    **kwargs
    ...
    @labels.setter
    def labels(self, labels: list[str] | tuple[str, str, str] | tuple[str, str, str, str, str, str]):
        ...
