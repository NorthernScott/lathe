...
class VolumeProperty(_vtk.vtkVolumeProperty):
    ...
    """
    def __init__(self, lookup_table=..., interpolation_type=..., ambient=..., diffuse=..., specular=..., specular_power=..., shade=..., opacity_unit_distance=...) -> None:
        """Initialize the vtkVolumeProperty class."""
        ...
    
    def apply_lookup_table(self, lookup_table: pyvista.LookupTable): # -> None:
