...
class WidgetHelper:
    ...
    def add_box_widget(self, callback, bounds=..., factor=..., rotation_enabled=..., color=..., use_planes=..., outline_translation=..., pass_widget=..., interaction_event=...): # -> vtkBoxWidget:
    ...
    def clear_box_widgets(self): # -> None:
    ...
    def add_plane_widget(self, callback, normal=..., origin=..., bounds=..., factor=..., color=..., assign_to_axis=..., tubing=..., outline_translation=..., origin_translation=..., implicit=..., pass_widget=..., test_callback=..., normal_rotation=..., interaction_event=..., outline_opacity=...): # -> vtkImplicitPlaneWidget | vtkPlaneWidget:
    ...
    def add_volume_clip_plane(self, volume, normal=..., invert=..., widget_color=..., value=..., assign_to_axis=..., tubing=..., origin_translation=..., outline_translation=..., implicit=..., normal_rotation=..., interaction_event=..., origin=..., outline_opacity=..., **kwargs): # -> vtkImplicitPlaneWidget | vtkPlaneWidget:
    ...
    def add_mesh_slice_orthogonal(self, mesh, generate_triangles=..., widget_color=..., tubing=..., interaction_event=..., **kwargs): # -> list[Any]:
    ...
    def add_line_widget(self, callback, bounds=..., factor=..., resolution=..., color=..., use_vertices=..., pass_widget=..., interaction_event=...): # -> vtkLineWidget:
    ...
    def clear_line_widgets(self): # -> None:
        """Remove all of the line widgets."""
        ...
    
    def add_text_slider_widget(self, callback, data, value=..., pointa=..., pointb=..., color=..., interaction_event=..., style=...): # -> vtkSliderWidget:
    ...
    def add_slider_widget(self, callback, rng, value=..., title=..., pointa=..., pointb=..., color=..., pass_widget=..., interaction_event=..., style=..., title_height=..., title_opacity=..., title_color=..., fmt=..., slider_width=..., tube_width=...): # -> vtkSliderWidget:
    ...
    def add_spline_widget(self, callback, bounds=..., factor=..., n_handles=..., resolution=..., color=..., show_ribbon=..., ribbon_color=..., ribbon_opacity=..., pass_widget=..., closed=..., initial_points=..., interaction_event=...): # -> vtkSplineWidget:
    ...
    def clear_spline_widgets(self): # -> None:
    ...
    def add_measurement_widget(self, callback=..., color=...): # -> vtkDistanceWidget:
    ...
    def clear_measure_widgets(self): # -> None:
        """Remove all of the measurement widgets."""
        ...
    
    def add_sphere_widget(self, callback, center=..., radius=..., theta_resolution=..., phi_resolution=..., color=..., style=..., selected_color=..., indices=..., pass_widget=..., test_callback=..., interaction_event=...): # -> list[Any] | vtkSphereWidget:
    ...
    def clear_sphere_widgets(self): # -> None:
        """Remove all of the sphere widgets."""
        ...
    
    def add_affine_transform_widget(self, actor, origin=..., start=..., scale=..., line_radius=..., always_visible=..., axes_colors=..., axes=..., release_callback=..., interact_callback=...): # -> AffineWidget3D:
    ...
    def add_checkbox_button_widget(self, callback, value=..., position=..., size=..., border_size=..., color_on=..., color_off=..., background_color=...): # -> vtkButtonWidget:
    ...
    def add_camera_orientation_widget(self, animate=..., n_frames=...): # -> vtkCameraOrientationWidget:
    ...
    def clear_button_widgets(self): # -> None:
        """Remove all of the button widgets."""
        ...
    
    def add_logo_widget(self, logo: pyvista.ImageData | str | pathlib.Path | None = ..., position: tuple[float, float] | Sequence[float] | NumpyArray[float] = ..., size: tuple[float, float] | Sequence[float] | NumpyArray[float] = ..., opacity: float = ...): # -> vtkLogoWidget:
    ...
    def clear_logo_widgets(self): # -> None:
        """Remove all of the logo widgets."""
        ...
    
    def add_camera3d_widget(self): # -> vtkCamera3DWidget:
    ...
    def clear_camera3d_widgets(self): # -> None:
