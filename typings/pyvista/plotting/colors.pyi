...
class Color:
    ...
    def __getitem__(self, item): # -> float | tuple[float, ...]:
...
PARAVIEW_BACKGROUND = ...
def get_cmap_safe(cmap): # -> Any | Colormap | <subclass of str and Colormap> | ListedColormap:
    """
...
def get_default_cycler(): # -> Cycler[str, str]:
...
def get_hexcolors_cycler(): # -> Cycler[str, str]:
...
def get_matplotlib_theme_cycler(): # -> Any:
    """
...
def color_scheme_to_cycler(scheme): # -> Cycler[str, Any]:
...
def get_cycler(color_cycler): # -> Cycler[str, str] | Any | Cycler[str, Any] | Cycler[Any, Any] | None:
