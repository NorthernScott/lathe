...
class RenderPasses:
    ...
    def enable_edl_pass(self): # -> vtkEDLShading | None:
        """Enable the EDL pass.
    ...
    def add_blur_pass(self): # -> vtkGaussianBlurPass:
    ...
    def enable_shadow_pass(self): # -> vtkShadowMapPass | None:
        """Enable shadow pass.
    ...
    def enable_depth_of_field_pass(self, automatic_focal_distance=...): # -> vtkDepthOfFieldPass | None:
    ...
    def enable_ssao_pass(self, radius, bias, kernel_size, blur): # -> vtkSSAOPass | None:
    ...
    def enable_ssaa_pass(self): # -> vtkSSAAPass | None:
