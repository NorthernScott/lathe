...
class Timer:
    ...
    def execute(self, obj, _event): # -> None:
        """Execute Timer."""
        ...
...
class RenderWindowInteractor:
    ...
    def add_timer_event(self, max_steps, duration, callback): # -> None:
    ...
    def add_observer(self, event, call, interactor_style_fallback=...): # -> int:
    ...
    def clear_events_for_key(self, key, raise_on_missing=...): # -> None:
    ...
    def track_mouse_position(self, callback): # -> None:
    ...
    def track_click_position(self, callback=..., side=..., double=..., viewport=...): # -> None:
    ...
    def untrack_click_position(self, side=...): # -> None:
    ...
    def key_press_event(self, *args): # -> None:
    ...
    @property
    def style(self): # -> vtkContextInteractorStyle | None:
    ...
    def enable_custom_trackball_style(self, left=..., shift_left=..., control_left=..., middle=..., shift_middle=..., control_middle=..., right=..., shift_right=..., control_right=...): # -> None:
    ...
    def enable_terrain_style(self, mouse_wheel_zooms=..., shift_pans=...): # -> None:
    ...
    def get_poked_renderer(self, x=..., y=...): # -> vtkRenderer:
    ...
    @contextmanager
    def poked_subplot(self): # -> Generator[None, Any, None]:
        """Activate the subplot that was last interacted."""
        ...
    
    def get_interactor_style(self): # -> vtkInteractorObserver:
    ...
    def create_timer(self, duration, repeating=...): # -> int:
        """Create a timer.
    ...
    def destroy_timer(self, timer_id): # -> None:
    ...
    def set_render_window(self, render_window): # -> None:
    ...
    @property
    def picker(self): # -> vtkAbstractPicker:
        """Get/set the picker.
    ...
    def add_pick_obeserver(self, observer): # -> None:
    ...
    def add_pick_observer(self, observer): # -> None:
        """Add an observer to call back when pick events end.
    ...
    def fly_to(self, renderer, point): # -> None:
