...
if TYPE_CHECKING:
    ...
def make_axis_labels(vmin, vmax, n, fmt): # -> vtkStringArray:
    """
...
class CubeAxesActor(_vtk.vtkCubeAxesActor):
    ...
    @title_offset.setter
    def title_offset(self, offset: float): # -> None:
        ...
    ...
    @camera.setter
    def camera(self, camera: pyvista.Camera): # -> None:
        ...
