...
def orientation_cube(): # -> dict[str, DataSet | pyvista_ndarray | None]:
...
def orientation_plotter(): # -> Plotter:
...
def plot_wave(fps=..., frequency=..., wavetime=..., notebook=...): # -> pyvista_ndarray | Any:
