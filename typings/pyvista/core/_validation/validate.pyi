...
if TYPE_CHECKING:
    ...
def validate_array(arr, /, *, must_have_shape=..., must_have_dtype=..., must_have_length=..., must_have_min_length=..., must_have_max_length=..., must_be_nonnegative=..., must_be_finite=..., must_be_real=..., must_be_integer=..., must_be_sorted=..., must_be_in_range=..., strict_lower_bound=..., strict_upper_bound=..., reshape_to=..., broadcast_to=..., dtype_out=..., as_any=..., copy=..., to_list=..., to_tuple=..., name=...): # -> Tuple[Any] | Tuple[Tuple[Any]] | Tuple[Tuple[Tuple[Any]]] | Tuple[Tuple[Tuple[Tuple[Any]]]] | Any | NDArray[Any]:
...
def validate_axes(*axes, normalize=..., must_be_orthogonal=..., must_have_orientation=..., name=...): # -> Any | Tuple[Any] | Tuple[Tuple[Any]] | Tuple[Tuple[Tuple[Any]]] | Tuple[Tuple[Tuple[Tuple[Any]]]] | NDArray[Any] | NDArray[float64]:
...
def validate_transform4x4(transform, /, *, name=...): # -> NDArray[float64] | NumpyArray | Tuple[Any] | Tuple[Tuple[Any]] | Tuple[Tuple[Tuple[Any]]] | Tuple[Tuple[Tuple[Tuple[Any]]]] | Any:
...
def validate_transform3x3(transform, /, *, name=...): # -> NumpyArray | Tuple[Any] | Tuple[Tuple[Any]] | Tuple[Tuple[Tuple[Any]]] | Tuple[Tuple[Tuple[Tuple[Any]]]] | Any:
...
def validate_number(num, /, *, reshape=..., **kwargs): # -> Tuple[Any] | Tuple[Tuple[Any]] | Tuple[Tuple[Tuple[Any]]] | Tuple[Tuple[Tuple[Tuple[Any]]]] | Any | NDArray[Any]:
...
def validate_data_range(rng, /, **kwargs): # -> Tuple[Any] | Tuple[Tuple[Any]] | Tuple[Tuple[Tuple[Any]]] | Tuple[Tuple[Tuple[Tuple[Any]]]] | Any | NDArray[Any]:
...
def validate_arrayNx3(arr, /, *, reshape=..., **kwargs): # -> Tuple[Any] | Tuple[Tuple[Any]] | Tuple[Tuple[Tuple[Any]]] | Tuple[Tuple[Tuple[Tuple[Any]]]] | Any | NDArray[Any]:
...
def validate_arrayN(arr, /, *, reshape=..., **kwargs): # -> Tuple[Any] | Tuple[Tuple[Any]] | Tuple[Tuple[Tuple[Any]]] | Tuple[Tuple[Tuple[Tuple[Any]]]] | Any | NDArray[Any]:
...
def validate_arrayN_unsigned(arr, /, *, reshape=..., **kwargs): # -> Tuple[Any] | Tuple[Tuple[Any]] | Tuple[Tuple[Tuple[Any]]] | Tuple[Tuple[Tuple[Tuple[Any]]]] | Any | NDArray[Any]:
...
def validate_array3(arr, /, *, reshape=..., broadcast=..., **kwargs): # -> Tuple[Any] | Tuple[Tuple[Any]] | Tuple[Tuple[Tuple[Any]]] | Tuple[Tuple[Tuple[Tuple[Any]]]] | Any | NDArray[Any]:
