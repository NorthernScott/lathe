...
def validate_axes(*axes, normalize=..., must_be_orthogonal=..., must_have_orientation=..., name=...):
...
def validate_transform4x4(transform, /, *, name=...):
...
def validate_transform3x3(transform, /, *, name=...):
...
def validate_number(num, /, *, reshape=..., **kwargs):
...
def validate_arrayNx3(arr, /, *, reshape=..., **kwargs):
...
def validate_arrayN(arr, /, *, reshape=..., **kwargs):
...
def validate_arrayN_unsigned(arr, /, *, reshape=..., **kwargs):
...
def validate_array3(arr, /, *, reshape=..., broadcast=..., **kwargs):
