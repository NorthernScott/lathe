...
if TYPE_CHECKING:
    ...
def check_subdtype(input_obj: Union[npt.DTypeLike, _ArrayLikeOrScalar[NumberType]], /, base_dtype: Union[npt.DTypeLike, tuple[npt.DTypeLike, ...], list[npt.DTypeLike]], *, name: str = ...):
...
def check_real(array: _ArrayLikeOrScalar[NumberType], /, *, name: str = ...):
...
def check_sorted(array: _ArrayLikeOrScalar[NumberType], /, *, ascending: bool = ..., strict: bool = ..., axis: int = ..., name: str = ...):
...
def check_integer(arr, /, *, strict=..., name=...):
...
def check_nonnegative(arr, /, *, name=...):
...
def check_greater_than(arr, /, value, *, strict=..., name=...):
...
def check_less_than(arr, /, value, *, strict=..., name=...):
...
def check_range(arr, /, rng, *, strict_lower=..., strict_upper=..., name=...):
...
def check_shape(arr, /, shape, *, name=...):
...
def check_string(obj, /, *, allow_subclass=..., name=...):
...
def check_instance(obj, /, classinfo, *, allow_subclass=..., name=...):
...
def check_type(obj, /, classinfo, *, name=...):
...
def check_iterable_items(iterable_obj, /, item_type, *, allow_subclass=..., name=...):
...
def check_contains(*, item, container, name=...):
...
def check_length(arr, /, *, exact_length=..., min_length=..., max_length=..., must_be_1d=..., allow_scalars=..., name=...):
