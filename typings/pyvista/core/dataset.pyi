...
class ActiveArrayInfo:
    ...
    def __iter__(self): # -> Iterator[FieldAssociation | str]:
...
class DataSet(DataSetFilters, DataObject):
    ...
    **kwargs :
    ...
    def active_tensors_name(self, name: str): # -> None:
    ...
    def __setitem__(self, name: str, scalars: NumpyArray[float] | Sequence[float] | float): # -> None:
