...
class _PointSet(DataSet):
    ...
    def translate(self, xyz: VectorLike[float], transform_all_input_vectors=..., inplace=...): # -> Self:
        """Translate the mesh.
...
class PointSet(_PointSet, _vtk.vtkPointSet):
    ...
    def cast_to_polydata(self, deep=...): # -> PolyData:
    ...
    def threshold(self, *args, **kwargs): # -> PointSet | Any:
    ...
    def threshold_percent(self, *args, **kwargs): # -> PointSet | Any:
        """Cast to PolyData and threshold.
    ...
    def explode(self, *args, **kwargs): # -> PointSet | Any:
    ...
    def delaunay_3d(self, *args, **kwargs): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
...
class PolyData(_PointSet, PolyDataFilters, _vtk.vtkPolyData):
    ...
    def regular_faces(self, faces: MatrixLike[int]): # -> None:
        """Set the face cells from an (n_faces, face_size) array."""
        ...
    
    @classmethod
    def from_regular_faces(cls, points: MatrixLike[float], faces: MatrixLike[int], deep=...): # -> Self:
    ...
    def irregular_faces(self, faces: Sequence[VectorLike[int]]): # -> None:
        """Set the faces from a sequence of face arrays."""
        ...
    
    @classmethod
    def from_irregular_faces(cls, points: MatrixLike[float], faces: Sequence[VectorLike[int]]): # -> Self:
    ...
    def __sub__(self, cutting_mesh): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def save(self, filename, binary=..., texture=..., recompute_normals=...): # -> None:
...
class PointGrid(_PointSet):
    ...
    def plot_curvature(self, curv_type=..., **kwargs): # -> Any:
...
class UnstructuredGrid(PointGrid, UnstructuredGridFilters, _vtk.vtkUnstructuredGrid):
    ...
    def linear_copy(self, deep=...): # -> Self:
    ...
    def cast_to_explicit_structured_grid(self): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
...
class StructuredGrid(PointGrid, StructuredGridFilters, _vtk.vtkStructuredGrid):
    ...
    **kwargs : dict, optional
    ...
    @property
    def y(self): # -> NumpyArray:
        """Return the Y coordinates of all points."""
        ...
    
    @property
    def z(self): # -> NumpyArray:
        """Return the Z coordinates of all points."""
        ...
    
    @property
    def points_matrix(self): # -> ndarray[Any, Any]:
        """Points as a 4-D matrix, with x/y/z along the last dimension."""
        ...
    
    def __getitem__(self, key): # -> NumpyArray | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
        """Slice subsets of the StructuredGrid, or extract an array field."""
        ...
    
    def hide_cells(self, ind, inplace=...): # -> Self:
...
class ExplicitStructuredGrid(PointGrid, _vtk.vtkExplicitStructuredGrid):
    ...
    def compute_connections(self, inplace=...): # -> Self:
