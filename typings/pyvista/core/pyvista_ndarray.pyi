...
class pyvista_ndarray(np.ndarray):
    ...
    """
    def __new__(cls, array: ArrayLike[float] | _vtk.vtkAbstractArray, dataset=..., association=...): # -> Self:
        """Allocate the array."""
        ...
    ...
    def __array_wrap__(self, out_arr, context=..., return_scalar=...): # -> ndarray[Any, Any]:
