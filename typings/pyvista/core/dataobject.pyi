...
class DataObject:
    ...
    **kwargs :
    ...
    def head(self, display=..., html=...): # -> str | None:
    ...
    def copy_meta_from(self, *args, **kwargs): # -> None:
    ...
    def add_field_data(self, array: NumpyArray[float], name: str, deep: bool = ...): # -> None:
        """Add field data.
    ...
    @user_dict.setter
    def user_dict(self, dict_: dict[str, _JSONValueType] | UserDict): # -> None:
        ...
