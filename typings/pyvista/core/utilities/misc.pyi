...
def assert_empty_kwargs(**kwargs): # -> Literal[True]:
...
class AnnotatedIntEnum(int, enum.Enum):
    """Annotated enum type."""
    annotation: str
    def __new__(cls, value, annotation: str): # -> Self:
        """Initialize."""
        ...
    
    @classmethod
    def from_str(cls, input_str): # -> AnnotatedIntEnum:
...
def threaded(fn): # -> Callable[..., Thread]:
