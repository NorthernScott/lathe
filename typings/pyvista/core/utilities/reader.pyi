...
if TYPE_CHECKING:
    ...
HDF_HELP = ...
def lazy_vtkPOpenFOAMReader(): # -> vtkPOpenFOAMReader:
    """Lazy import of the vtkPOpenFOAMReader."""
    ...

def get_reader(filename, force_ext=...): # -> DICOMReader:
...
class BaseVTKReader(ABC):
    ...
    def GetOutputDataObject(self, *args): # -> None:
        """Return stored data."""
        ...
...
class BaseReader:
    ...
    def read(self): # -> DataSet | pyvista_ndarray:
        """Read data in file.
...
class PointCellDataSelection:
    ...
    @property
    def point_array_names(self): # -> list[Any]:
    ...
    def point_array_status(self, name): # -> bool:
    ...
    @property
    def all_point_arrays_status(self): # -> dict[Any, bool]:
    ...
    @property
    def cell_array_names(self): # -> list[Any]:
    ...
    def cell_array_status(self, name): # -> bool:
    ...
    @property
    def all_cell_arrays_status(self): # -> dict[Any, bool]:
...
class TimeReader(ABC):
    ...
    @property
    @abstractmethod
    def number_time_points(self): # -> None:
    ...
    @abstractmethod
    def time_point_value(self, time_point): # -> None:
    ...
    @property
    @abstractmethod
    def active_time_value(self): # -> None:
...
class EnSightReader(BaseReader, PointCellDataSelection, TimeReader):
    ...
    _vtk_class_name = ...
    @property
    def number_time_points(self): # -> Any:
        ...
    
    def time_point_value(self, time_point): # -> Any:
        ...
    
    @property
    def active_time_value(self): # -> Any:
        ...
...
class OpenFOAMReader(BaseReader, PointCellDataSelection, TimeReader):
    ...
    @property
    def number_patch_arrays(self): # -> Any:
    ...
    @property
    def patch_array_names(self): # -> list[Any]:
    ...
    def patch_array_status(self, name): # -> bool:
    ...
    @property
    def all_patch_arrays_status(self): # -> dict[Any, bool]:
...
class MultiBlockPlot3DReader(BaseReader):
    ...
    @property
    def auto_detect_format(self): # -> bool:
    ...
    @property
    def preserve_intermediate_functions(self): # -> Any:
...
class CGNSReader(BaseReader, PointCellDataSelection):
    ...
    @property
    def base_array_names(self): # -> list[Any]:
...
class GaussianCubeReader(BaseReader):
    ...
    _vtk_module_name = ...
    _vtk_class_name = ...
    def read(self, grid: bool = ...): # -> DataSet | pyvista_ndarray:
