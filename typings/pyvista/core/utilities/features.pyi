...
def voxelize(mesh, density=..., check_surface=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
...
def voxelize_volume(mesh, density=..., check_surface=...): # -> RectilinearGrid:
...
def create_grid(dataset, dimensions=...): # -> ImageData:
...
def grid_from_sph_coords(theta, phi, r): # -> StructuredGrid:
...
def transform_vectors_sph_to_cart(theta, phi, r, u, v, w): # -> tuple[Any, Any, Any]:
...
def spherical_to_cartesian(r, phi, theta): # -> tuple[Any, Any, Any]:
...
def perlin_noise(amplitude, freq: Sequence[float], phase: Sequence[float]): # -> vtkPerlinNoise:
...
def sample_function(function: _vtk.vtkImplicitFunction, bounds: Sequence[float] = ..., dim: Sequence[int] = ..., compute_normals: bool = ..., output_type: np.dtype = ..., capping: bool = ..., cap_value: float = ..., scalar_arr_name: str = ..., normal_arr_name: str = ..., progress_bar: bool = ...): # -> DataSet | pyvista_ndarray | None:
