...
class ImageEllipsoidSource(_vtk.vtkImageEllipsoidSource):
    ...
    """
    def __init__(self, whole_extent=..., center=..., radius=...) -> None:
        ...
...
class ImageMandelbrotSource(_vtk.vtkImageMandelbrotSource):
    ...
    >>> source.output.plot(cpos="xy")
    """
    def __init__(self, whole_extent=..., maxiter=...) -> None:
        ...
...
class ImageNoiseSource(_vtk.vtkImageNoiseSource):
    ...
    def __init__(self, whole_extent=..., minimum=..., maximum=..., seed=...) -> None:
        ...
...
class ImageSinusoidSource(_vtk.vtkImageSinusoidSource):
    ...
    """
    _new_attr_exceptions: ClassVar[list[str]] = ...
    def __init__(self, whole_extent=..., direction=..., period=..., phase=..., amplitude=...) -> None:
        ...
...
class ImageGaussianSource(_vtk.vtkImageGaussianSource):
    ...
    """
    _new_attr_exceptions: ClassVar[list[str]] = ...
    def __init__(self, center=..., whole_extent=..., maximum=..., std=...) -> None:
        ...
...
class ImageGridSource(_vtk.vtkImageGridSource):
    ...
    >>> source.output.plot(cpos="xy")
    """
    def __init__(self, origin=..., extent=..., spacing=...) -> None:
        ...
