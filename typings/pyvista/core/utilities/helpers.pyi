...
def is_pyvista_dataset(obj): # -> bool:
...
def generate_plane(normal, origin): # -> vtkPlane:
...
def axis_rotation(points, angle, inplace=..., deg=..., axis=...): # -> Any | ndarray[Any, dtype[floating[Any]]] | None:
...
def is_inside_bounds(point, bounds): # -> bool:
