...
"""
NORMALS = ...
def Capsule(center=..., direction=..., radius=..., cylinder_length=..., resolution=...):
...
def Cylinder(center=..., direction=..., radius=..., height=..., resolution=..., capping=...):
...
def CylinderStructured(radius=..., height=..., center=..., direction=..., theta_resolution=..., z_resolution=...):
...
def Arrow(start=..., direction=..., tip_length=..., tip_radius=..., tip_resolution=..., shaft_radius=..., shaft_resolution=..., scale=...):
    """Create an arrow.
...
def Sphere(radius=..., center=..., direction=..., theta_resolution=..., phi_resolution=..., start_theta=..., end_theta=..., start_phi=..., end_phi=...):
    """Create a sphere.
...
def SolidSphere(outer_radius=..., inner_radius=..., radius_resolution=..., start_theta=..., end_theta=..., theta_resolution=..., start_phi=..., end_phi=..., phi_resolution=..., center=..., direction=..., radians=..., tol_radius=..., tol_angle=...):
...
def SolidSphereGeneric(radius=..., theta=..., phi=..., center=..., direction=..., radians=..., tol_radius=..., tol_angle=...):
...
def Plane(center=..., direction=..., i_size=..., j_size=..., i_resolution=..., j_resolution=...):
    """Create a plane.
...
def Line(pointa=..., pointb=..., resolution=...):
    """Create a line.
...
def Tube(pointa=..., pointb=..., resolution=..., radius=..., n_sides=...):
    """Create a tube.
...
def Cube(center=..., x_length=..., y_length=..., z_length=..., bounds=..., clean=..., point_dtype=...):
    """Create a cube.
...
def Cone(center=..., direction=..., height=..., radius=..., capping=..., angle=..., resolution=...):
    """Create a cone.
...
def Polygon(center=..., radius=..., normal=..., n_sides=..., fill=...):
    """Create a polygon.
...
def Disc(center=..., inner=..., outer=..., normal=..., r_res=..., c_res=...):
...
def Text3D(string, depth=..., width=..., height=..., center=..., normal=...):
...
def Wavelet(extent=..., center=..., maximum=..., x_freq=..., y_freq=..., z_freq=..., x_mag=..., y_mag=..., z_mag=..., std=..., subsample_rate=...):
    """Create a wavelet.
...
def CircularArc(pointa, pointb, center, resolution=..., negative=...):
...
def CircularArcFromNormal(center, resolution=..., normal=..., polar=..., angle=...):
...
def Ellipse(semi_major_axis=..., semi_minor_axis=..., resolution=...):
...
def Superquadric(center=..., scale=..., size=..., theta_roundness=..., phi_roundness=..., theta_resolution=..., phi_resolution=..., toroidal=..., thickness=...):
...
def PlatonicSolid(kind=..., radius=..., center=...):
...
def Icosphere(radius=..., center=..., nsub=...):
    """Create an icosphere.
