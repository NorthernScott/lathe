...
"""
NORMALS = ...
def Capsule(center=..., direction=..., radius=..., cylinder_length=..., resolution=...): # -> DataSet | pyvista_ndarray | None:
...
def Cylinder(center=..., direction=..., radius=..., height=..., resolution=..., capping=...): # -> DataSet | pyvista_ndarray | None:
...
def CylinderStructured(radius=..., height=..., center=..., direction=..., theta_resolution=..., z_resolution=...): # -> StructuredGrid:
...
def Arrow(start=..., direction=..., tip_length=..., tip_radius=..., tip_resolution=..., shaft_radius=..., shaft_resolution=..., scale=...): # -> DataSet | pyvista_ndarray | None:
    """Create an arrow.
...
def Sphere(radius=..., center=..., direction=..., theta_resolution=..., phi_resolution=..., start_theta=..., end_theta=..., start_phi=..., end_phi=...): # -> DataSet | pyvista_ndarray | None:
    """Create a sphere.
...
def SolidSphere(outer_radius=..., inner_radius=..., radius_resolution=..., start_theta=..., end_theta=..., theta_resolution=..., start_phi=..., end_phi=..., phi_resolution=..., center=..., direction=..., radians=..., tol_radius=..., tol_angle=...): # -> UnstructuredGrid:
...
def SolidSphereGeneric(radius=..., theta=..., phi=..., center=..., direction=..., radians=..., tol_radius=..., tol_angle=...): # -> UnstructuredGrid:
...
def Plane(center=..., direction=..., i_size=..., j_size=..., i_resolution=..., j_resolution=...): # -> DataSet | pyvista_ndarray | None:
    """Create a plane.
...
def Line(pointa=..., pointb=..., resolution=...): # -> DataSet | pyvista_ndarray | None:
    """Create a line.
...
def MultipleLines(points=...): # -> DataSet | pyvista_ndarray | None:
...
def Tube(pointa=..., pointb=..., resolution=..., radius=..., n_sides=...): # -> Any:
    """Create a tube.
...
def Cube(center=..., x_length=..., y_length=..., z_length=..., bounds=..., clean=..., point_dtype=...): # -> DataSet | pyvista_ndarray | None:
    """Create a cube.
...
def Box(bounds=..., level=..., quads=...): # -> DataSet | pyvista_ndarray | None:
...
def Cone(center=..., direction=..., height=..., radius=..., capping=..., angle=..., resolution=...): # -> DataSet | pyvista_ndarray | None:
    """Create a cone.
...
def Polygon(center=..., radius=..., normal=..., n_sides=..., fill=...): # -> DataSet | pyvista_ndarray | None:
    """Create a polygon.
...
def Disc(center=..., inner=..., outer=..., normal=..., r_res=..., c_res=...): # -> DataSet | pyvista_ndarray | None:
...
def Text3D(string, depth=..., width=..., height=..., center=..., normal=...): # -> vtkPolyData:
...
def Wavelet(extent=..., center=..., maximum=..., x_freq=..., y_freq=..., z_freq=..., x_mag=..., y_mag=..., z_mag=..., std=..., subsample_rate=...): # -> DataSet | pyvista_ndarray | None:
    """Create a wavelet.
...
def CircularArc(pointa, pointb, center, resolution=..., negative=...): # -> DataSet | pyvista_ndarray | None:
...
def CircularArcFromNormal(center, resolution=..., normal=..., polar=..., angle=...): # -> DataSet | pyvista_ndarray | None:
...
def Pyramid(points=...): # -> DataSet | pyvista_ndarray | None:
...
def Triangle(points=...): # -> DataSet | pyvista_ndarray | None:
...
def Quadrilateral(points=...): # -> DataSet | pyvista_ndarray | None:
...
def Circle(radius=..., resolution=...): # -> DataSet | pyvista_ndarray | None:
...
def Ellipse(semi_major_axis=..., semi_minor_axis=..., resolution=...): # -> DataSet | pyvista_ndarray | None:
...
def Superquadric(center=..., scale=..., size=..., theta_roundness=..., phi_roundness=..., theta_resolution=..., phi_resolution=..., toroidal=..., thickness=...): # -> DataSet | pyvista_ndarray | None:
...
def PlatonicSolid(kind=..., radius=..., center=...): # -> DataSet | pyvista_ndarray | None:
...
def Tetrahedron(radius=..., center=...): # -> DataSet | pyvista_ndarray | None:
...
def Octahedron(radius=..., center=...): # -> DataSet | pyvista_ndarray | None:
...
def Dodecahedron(radius=..., center=...): # -> DataSet | pyvista_ndarray | None:
...
def Icosahedron(radius=..., center=...): # -> DataSet | pyvista_ndarray | None:
...
def Icosphere(radius=..., center=..., nsub=...): # -> Any:
    """Create an icosphere.
