...
class MultiBlock(CompositeFilters, DataObject, MutableSequence, _vtk.vtkMultiBlockDataSet):
    ...
    **kwargs : dict, optional
    ...
    def append(self, dataset: _TypeMultiBlockLeaf | None, name: str | None = ...):
    ...
    def __setitem__(self, index: int | str | slice, data):
    ...
    def as_polydata_blocks(self, copy=...):
