...
class StructuredGridFilters(DataSetFilters):
    ...
    def extract_subset(self, voi, rate=..., boundary=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def concatenate(self, other, axis, tolerance=...): # -> StructuredGrid:
