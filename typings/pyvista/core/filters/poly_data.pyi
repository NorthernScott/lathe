...
class PolyDataFilters(DataSetFilters):
    ...
    def edge_mask(self, angle, progress_bar=...): # -> NDArray[bool]:
    ...
    def boolean_union(self, other_mesh, tolerance=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def boolean_intersection(self, other_mesh, tolerance=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def boolean_difference(self, other_mesh, tolerance=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def __add__(self, dataset): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | PolyData | DataSetFilters | None:
        """Merge these two meshes."""
        ...
    
    def __iadd__(self, dataset): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | PolyData | DataSetFilters | None:
    ...
    def append_polydata(self, *meshes, inplace=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def merge(self, dataset, merge_points=..., tolerance=..., inplace=..., main_has_priority=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | PolyData | DataSetFilters | None:
    ...
    def intersection(self, mesh, split_first=..., split_second=..., progress_bar=...): # -> tuple[PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None, PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None, PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None]:
    ...
    def curvature(self, curv_type=..., progress_bar=...): # -> NDArray[float64]:
    ...
    def smooth(self, n_iter=..., relaxation_factor=..., convergence=..., edge_angle=..., feature_angle=..., boundary_smoothing=..., feature_smoothing=..., inplace=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def smooth_taubin(self, n_iter=..., pass_band=..., edge_angle=..., feature_angle=..., boundary_smoothing=..., feature_smoothing=..., non_manifold_smoothing=..., normalize_coordinates=..., inplace=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def decimate_pro(self, reduction, feature_angle=..., split_angle=..., splitting=..., pre_split_mesh=..., preserve_topology=..., boundary_vertex_deletion=..., max_degree=..., inplace=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def tube(self, radius=..., scalars=..., capping=..., n_sides=..., radius_factor=..., absolute=..., preference=..., inplace=..., progress_bar=...): # -> PolyData | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def subdivide(self, nsub, subfilter=..., inplace=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def subdivide_adaptive(self, max_edge_len=..., max_tri_area=..., max_n_tris=..., max_n_passes=..., inplace=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def decimate(self, target_reduction, volume_preservation=..., attribute_error=..., scalars=..., vectors=..., normals=..., tcoords=..., tensors=..., scalars_weight=..., vectors_weight=..., normals_weight=..., tcoords_weight=..., tensors_weight=..., inplace=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def compute_normals(self, cell_normals=..., point_normals=..., split_vertices=..., flip_normals=..., consistent_normals=..., auto_orient_normals=..., non_manifold_traversal=..., feature_angle=..., inplace=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def clip_closed_surface(self, normal=..., origin=..., tolerance=..., inplace=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def fill_holes(self, hole_size, inplace=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def clean(self, point_merging=..., tolerance=..., lines_to_points=..., polys_to_lines=..., strips_to_polys=..., inplace=..., absolute=..., progress_bar=..., **kwargs): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
        """Clean the mesh.
    ...
    def geodesic(self, start_vertex, end_vertex, inplace=..., keep_order=..., use_scalar_weights=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def geodesic_distance(self, start_vertex, end_vertex, use_scalar_weights=..., progress_bar=...): # -> Any:
    ...
    def ray_trace(self, origin, end_point, first_point=..., plot=..., off_screen=...): # -> tuple[Any | NDArray[float64], NDArray[Any]]:
    ...
    def multi_ray_trace(self, origins, directions, first_point=..., retry=...): # -> tuple[ndarray[Any, dtype[Any]] | Any, ndarray[Any, dtype[Any]] | Any, ndarray[Any, dtype[Any]] | Any]:
    ...
    def remove_points(self, remove, mode=..., keep_scalars=..., inplace=...): # -> tuple[Self, Any] | tuple[PolyData, Any]:
    ...
    def delaunay_2d(self, tol=..., alpha=..., offset=..., bound=..., inplace=..., edge_source=..., progress_bar=...): # -> Self | DataSet | PointSet | Any | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | DataSetFilters | None:
    ...
    def compute_arc_length(self, progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def project_points_to_plane(self, origin=..., normal=..., inplace=...): # -> Self:
    ...
    def ribbon(self, width=..., scalars=..., angle=..., factor=..., normal=..., tcoords=..., preference=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def extrude(self, vector, capping=..., inplace=..., progress_bar=...): # -> Self | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def extrude_rotate(self, resolution=..., inplace=..., translation=..., dradius=..., angle=..., capping=..., rotation_axis=..., progress_bar=...): # -> Self | DataSet | pyvista_ndarray | None:
    ...
    def extrude_trim(self, direction, trim_surface, extrusion=..., capping=..., inplace=..., progress_bar=...): # -> Self | DataSet | pyvista_ndarray | None:
    ...
    def strip(self, join=..., max_length=..., pass_cell_data=..., pass_cell_ids=..., pass_point_ids=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def collision(self, other_mesh, contact_mode=..., box_tolerance=..., cell_tolerance=..., n_cells_per_node=..., generate_scalars=..., progress_bar=...): # -> tuple[PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None, int]:
    ...
    def contour_banded(self, n_contours, rng=..., scalars=..., component=..., clip_tolerance=..., generate_contour_edges=..., scalar_mode=..., clipping=..., progress_bar=...): # -> tuple[PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None, DataSet | pyvista_ndarray | None] | PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def reconstruct_surface(self, nbr_sz=..., sample_spacing=..., progress_bar=...): # -> DataSet | pyvista_ndarray | None:
    ...
    def triangulate_contours(self, display_errors=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def protein_ribbon(self, progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
