...
class ImageDataFilters(DataSetFilters):
    ...
    def gaussian_smooth(self, radius_factor=..., std_dev=..., scalars=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def median_smooth(self, kernel_size=..., scalars=..., preference=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def extract_subset(self, voi, rate=..., boundary=..., progress_bar=...): # -> ImageData:
    ...
    def image_dilate_erode(self, dilate_value=..., erode_value=..., kernel_size=..., scalars=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def image_threshold(self, threshold, in_value=..., out_value=..., scalars=..., preference=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def fft(self, output_scalars_name=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def rfft(self, output_scalars_name=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def low_pass(self, x_cutoff, y_cutoff, z_cutoff, order=..., output_scalars_name=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def high_pass(self, x_cutoff, y_cutoff, z_cutoff, order=..., output_scalars_name=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def points_to_cells(self, scalars: str | None = ..., *, copy: bool = ...): # -> ImageData:
    ...
    def cells_to_points(self, scalars: str | None = ..., *, copy: bool = ...): # -> ImageData:
