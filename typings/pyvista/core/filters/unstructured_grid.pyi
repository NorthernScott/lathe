...
class UnstructuredGridFilters(DataSetFilters):
    ...
    def delaunay_2d(self, *args, **kwargs): # -> PolyDataFilters | DataSet | PointSet | Any | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | DataSetFilters | None:
        """Wrap ``PolyDataFilters.delaunay_2d``."""
        ...
    
    @wraps(PolyDataFilters.reconstruct_surface)
    def reconstruct_surface(self, *args, **kwargs): # -> DataSet | pyvista_ndarray | None:
        """Wrap ``PolyDataFilters.reconstruct_surface``."""
        ...
    
    def subdivide_tetra(self): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
    ...
    def clean(self, tolerance=..., remove_unused_points=..., produce_merge_map=..., average_point_data=..., merging_array_name=..., progress_bar=...): # -> PointSet | Any | DataSet | pyvista_ndarray | <subclass of DataSet and MultiBlock> | <subclass of pyvista_ndarray and MultiBlock> | None:
