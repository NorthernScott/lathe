...
class DataSetAttributes(_vtk.VTKObjectWrapper):
    ...
    def __setitem__(self, key: str, value: ArrayLike[Any]): # -> None:
    ...
    def set_scalars(self, scalars: ArrayLike[float], name=..., deep_copy=...): # -> None:
    ...
    def set_vectors(self, vectors: MatrixLike[float], name: str, deep_copy=...): # -> None:
    ...
    def update(self, array_dict: dict[str, NumpyArray[float]] | DataSetAttributes): # -> None:
    ...
    def active_normals(self, normals: MatrixLike[float]): # -> None:
        """Set the normals.
    ...
    def active_texture_coordinates(self, texture_coordinates: NumpyArray[float]): # -> None:
        """Set the active texture coordinates array.
